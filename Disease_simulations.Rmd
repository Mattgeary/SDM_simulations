...
Panel <- function(panel)
{
  par(xpd=NA)
  u <- par('usr')
  text(u[1]-(u[2]-u[1])*.01, u[4]+(u[4]-u[3])*.1, panel, cex=1)
  par(xpd=FALSE)
}
...
par(mfrow=c(2,2))
boxplot(sim.results[,c(1,3,5,7,9)], las=2, names=plot.labs)
Panel("(a)")
boxplot(sim.results[,c(2,4,6,8,10)], las=2, names=plot.labs)
Panel("(b)")
boxplot(sim.wrong[,c(1,3,5,7,9)], las=2, names=plot.labs)
Panel("(c)")
boxplot(sim.wrong[,c(2,4,6,8,10)], las=2, names=plot.labs)
Panel("(d)")
```
...
par(mfrow=c(2,2))
boxplot(kenya.results[,c(1,3,5,7,9)], las=2, names=plot.labs)
Panel("(a)")
boxplot(kenya.results[,c(2,4,6,8,10)], las=2, names=plot.labs)
Panel("(b)")
boxplot(kenya.wrong[,c(1,3,5,7,9)], las=2, names=plot.labs)
Panel("(c)")
boxplot(kenya.wrong[,c(2,4,6,8,10)], las=2, names=plot.labs)
Panel("(d)")
```
...
par(mfrow=c(2,2))
boxplot(comb.results[,c(1,3,5,7,9)], las=2, names=plot.labs)
Panel("(a)")
boxplot(comb.results[,c(2,4,6,8,10)], las=2, names=plot.labs)
Panel("(b)")
boxplot(comb.wrong[,c(1,3,5,7,9)], las=2, names=plot.labs)
Panel("(c)")
boxplot(comb.wrong[,c(2,4,6,8,10)], las=2, names=plot.labs)
Panel("(d)")
```